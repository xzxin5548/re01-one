...
let cams = [
    [0.35, -0.28, 0.89, 0, 0.53, 0.84, 0.07, 0, -0.78, 0.45, 0.44, 0, -0.3, -1.64, 4.2, 1],
    [0.95, 0.08, -0.28, 0, -0.22, 0.77, -0.59, 0, 0.16, 0.63, 0.76, 0, 0.25, -1.68, 4.88, 1],
    [0.83,0.08,0.55,0,0.39,0.64,-0.65,0,-0.41,0.76,0.5,0,-0.9,-1.33,5.03,1],
    [0.87,-0.5,-0.01,0,0.35,0.56,0.74,0,-0.36,-0.65,0.67,0,-0.3,0.97,4.93,1],
    [-0.33,-0.27,0.91,0,0.68,0.57,0.44,0,-0.64,0.77,0,0,0.84,-2.49,3.62,1],
    [-0.98,-0.05,0.2,0,0.14,0.43,0.88,0,-0.13,0.9,-0.41,0,0.74,-2.59,4.54,1],
    [-1,-0.06,-0.09,0,-0.11,0.27,0.95,0,-0.04,0.96,-0.27,0,0.72,-2.3,4.45,1],
    [-0.98,-0.01,-0.21,0,-0.2,-0.39,0.89,0,-0.09,0.91,0.39,0,0.86,-2.06,2.98,1],
    [-0.89,-0.3,0.35,0,0.33,0.06,0.93,0,-0.3,0.95,0.05,0,-0.09,-1.7,4.73,1],
    [0.91,0.03,0.42,0,0.27,0.74,-0.6,0,-0.32,0.67,0.67,0,-1.09,-1.13,5.53,1]
]
let camend =cams[1]
let camstart=cams[1]
...
let defaultViewMatrix = [
    0.33,-0.27,0.9,0,0.53,0.84,0.07,0,-0.79,0.46,0.42,0,-0.11,-1.64,4.21,1
];
// 实际使用的视图矩阵
...
async function renderer() {
    ...
    const url = new URL(
        // "nike.splat",
        // location.href,
        params.get("url") || "librarytl.splat",
